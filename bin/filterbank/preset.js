...
export const initPreset = () => {
    ...
    return {
        main: {
            ...
            bypass: new Parameter(BooleanMapping.Instance, MAIN_BYPASS_PRINT, false)
        },
        filter: {
            highPass: {
                enabled: new Parameter(BooleanMapping.Instance, FILTER_ENABLED_PRINT, false),
            ...
            lowShelf: {
                enabled: new Parameter(BooleanMapping.Instance, FILTER_ENABLED_PRINT, true),
